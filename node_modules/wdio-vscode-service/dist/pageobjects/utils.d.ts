...
type ClassWithFunctionLocators$<T> = {
    [key in keyof ClassWithFunctionLocatorsAsString<T> as `${key}$`]: (...args: Parameters<ClassWithFunctionLocatorsAsString<T>[key]>) => ChainablePromiseElement;
};
type ClassWithFunctionLocators$$<T> = {
    [key in keyof ClassWithFunctionLocatorsAsString<T> as `${key}$$`]: (...args: Parameters<ClassWithFunctionLocatorsAsString<T>[key]>) => ChainablePromiseArray;
};
type ClassWithLocators$<T> = {
    [key in keyof T & string as T[key] extends String | undefined ? `${key}$` : never]: ChainablePromiseElement;
};
type ClassWithLocators$$<T> = {
    [key in keyof T & string as T[key] extends String | undefined ? `${key}$$` : never]: ChainablePromiseArray;
};
...
export declare abstract class BasePage<PageLocators, LocatorMap extends Record<string, Locators> = VSCodeLocatorMap> {
     ...
     * @private
     */
    constructor(_locators: LocatorMap, _baseElem?: (string | ChainablePromiseElement) | undefined, _parentElem?: (string | ChainablePromiseElement) | undefined);
    /**
     ...
     * @private
     */
    get baseElem(): string | ChainablePromiseElement | undefined;
    /**
     * @private
     */
     ...
     */
    get parent(): ChainablePromiseElement;
    /**
     * @private
     */
    setParentElement(parentElem: string | ChainablePromiseElement): void;
    /**
