...
export declare class ScmProvider extends BasePage<typeof ScmViewLocators> {
     ...
     */
    locatorKey: "ScmView";
    constructor(locators: VSCodeLocatorMap, element: ChainablePromiseElement, view: ScmView);
    /**
...
export declare class ScmChange extends ElementWithContextMenu<typeof ScmViewLocators> {
     ...
     */
    locatorKey: "ScmView";
    constructor(locators: VSCodeLocatorMap, row: ChainablePromiseElement, provider: ScmProvider);
    /**
