...
export declare abstract class ViewSection extends BasePage<AllViewSectionLocators> {
    content: ViewContent;
    constructor(locators: VSCodeLocatorMap, panel: ChainablePromiseElement, content: ViewContent);
    /**
...
export declare class ViewPanelAction extends BasePage<typeof ViewSectionLocators> {
    ...
    constructor(locators: VSCodeLocatorMap, element: ChainablePromiseElement, viewPart: ViewSection);
    /**
