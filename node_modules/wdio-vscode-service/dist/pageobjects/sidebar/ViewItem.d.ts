...
export declare abstract class TreeItem extends ViewItem {
    ...
    protected findTwistie(): Promise<ChainablePromiseElement>;
}
...
export declare class ViewItemAction extends BasePage<typeof ViewSectionLocators> {
    ...
    private label;
    constructor(locators: VSCodeLocatorMap, elem: ChainablePromiseElement, label: string, viewItem: TreeItem);
    /**
